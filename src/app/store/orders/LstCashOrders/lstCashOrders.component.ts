...
@Component({
  selector : 'CashOrderList',
  templateUrl: './lstCashOrders.component.html',
  styleUrls: ['./lstCashOrders.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CashOrderLstComponent implements AfterViewInit , OnInit{
  ...
  filtersJSON : any = {};
    ...
    ngOnInit(){
      ...
      that.dtOptions = {
          ...
          dataTablesParameters.filters = that.filtersHidden ? null : that.filtersJSON;
            ...
            that.http.post<DataTablesResponse>(environment.apiUrl+'order/cash-datatable' , dataTablesParameters , {})
                        .subscribe(resp=>{
                          // return callback({
                          ...
                          CashOrderLstComponent.beingSearched = false;
                          //Order count spinner
                          CashOrderLstComponent.dataLengthChanged = false;
    ...
    dtDrawCallBack(){
        ...
        $("#pageCountDatatable .dropdown-menu a").on("click", function (event) {
          //Showing spinner
          CashOrderLstComponent.dataLengthChanged = true;
        ...
        CashOrderLstComponent.numOrders = "Displaying " +(api.page.info().start + 1) + "-" + api.page.info().end + " of " + api.page.info().recordsTotal + " orders";
        ...
        fromEvent( $("#searchDatatable") ,"keyup").pipe(
          ...
          CashOrderLstComponent.beingSearched = true;
          api.search(text).draw();
        });

    }
    get beingSearched(){
      return CashOrderLstComponent.beingSearched;
    }
    get dataLengthChanged(){
      return CashOrderLstComponent.dataLengthChanged;
    }
    get numOrders(){
      return CashOrderLstComponent.numOrders;
    }
